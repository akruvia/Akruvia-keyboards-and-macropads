...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LAYER_LOWER] = LAYOUT(
        ...
        KC_TRANSPARENT,	KC_HOME,	KC_PAGE_UP,	KC_PAGE_DOWN,	KC_END,	KC_NO,	KC_NO,	KC_PRINT_SCREEN,	KC_LEFT_BRACKET,	KC_RIGHT_BRACKET,	KC_UP,	KC_TRANSPARENT,
        KC_TRANSPARENT,	KC_TRANSPARENT,	KC_TRANSPARENT,	KC_CAPS_LOCK,	KC_TRANSPARENT,	KC_MINUS,	KC_EQUAL,	KC_TRANSPARENT,	KC_TRANSPARENT,	KC_LEFT,	KC_DOWN,	KC_RIGHT
    ),
    [_LAYER_UPPER] = LAYOUT(
